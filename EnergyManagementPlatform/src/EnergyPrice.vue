<template>
<div class="EnergPrice">
<div class="overview">
    <p class="header">
      <span style="color:#303030">价格搜索</span>
      <span class="fr el-icon-plus" @click="newTable">添加新价格合同</span>
   ...
   <span class="spanselect"> <el-select v-model="Facvalue" placeholder="工厂名称">
    ...
    <div>
      <div class="hetop">
        <i class="el-icon-document"></i> <i class="el-icon-circle-close"></i>
        海斯坦普/重庆工厂
       </div>
      <el-table :data="tableData" stripe style="width: 100%;" :cell-style="cellStyle" :header-cell-style="headerStyle" :row-class-name="tableRowClassName">
        ...
        <el-table-column prop="money" label="货币">
        </el-table-column>
        <el-table-column prop="Enery" label="能源">
        </el-table-column>
        <!-- <el-table-column prop="desc" label="率"></el-table-column>       -->
