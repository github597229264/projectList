<template>
<div class="EnergyUser">
<div class="overview">
    <p class="header">
      <span style="color:#303030">用户搜索</span>
      <span class="fr el-icon-plus" @click="newTable">添加新用户</span>
     <span class="spanselect" style="float:right;right: 194px;position: absolute;"> <el-select v-model="Comvalue" placeholder="请选择公司名称">
    <el-option
   ...
   <span class="spanselect"> <el-select v-model="Facvalue" placeholder="请选择工厂名称">
    ...
    <div>
      <el-table :data="tableData" stripe style="width: 100%;" :cell-style="cellStyle" :header-cell-style="headerStyle" :row-class-name="tableRowClassName">
        ...
        <el-table-column prop="move" label="部门"></el-table-column> 
