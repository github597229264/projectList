...
<div class="LightTimed">
  <div class="overview">
    <p class="header">
       <span style="float:left" >能源单位搜索</span>
        <span class="fr el-icon-plus" @click="newTable" >添加能源单位</span>
      ...
      <span style="float:right">
          ...
          <el-select v-model="valueDept" filterable placeholder="请选择" style="width:160px;float:right;" id="AllDept">
          <el-option
            v-for="(item,index) in groupOptions"
            :key="index"
            :label="item.label"
    ...
    <div>
      <el-table :data="tableData" stripe style="width: 100%;" :cell-style="cellStyle" :header-cell-style="headerStyle" :row-class-name="tableRowClassName">
        ...
        <el-table-column prop="desc" label="能源">
        </el-table-column>
        <!-- <el-table-column prop="together" label="聚合">
        </el-table-column> -->
